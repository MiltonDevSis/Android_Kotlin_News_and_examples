package com.example.navigationcomponentapp.ui.registration.chossecredentials
...
import com.example.navigationcomponentapp.extension.dismissError
...
import kotlinx.android.synthetic.main.fragment_chosse_credentials.*

class ChosseCredentials : Fragment() {

    private val loginViewModel: LoginViewModel by activityViewModels()
    private val registrationViewModel: RegistrationViewModel by activityViewModels()

    private val args: ChosseCredentialsArgs by navArgs()
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_chosse_credentials, container, false)
    }
